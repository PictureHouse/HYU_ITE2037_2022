...
public class City {
	...
	public boolean equals(City anotherCity) { // City 객체가 다른 City 객체와 같은지 비교하는 Method
		if (this.name.equals(anotherCity) && this.locationX == anotherCity.locationX
	...
	public static double distance(City city1, City city2) { // 두 City 객체 간의 거리를 반환하는 Method
		double result = Math
				.sqrt(Math.pow(city1.locationX - city2.locationX, 2) + Math.pow(city1.locationY - city2.locationY, 2));
		return result;
	}
}

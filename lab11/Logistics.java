...
public class Logistics {
	...
	public static <T extends Hub> void deliverBoxes(ArrayList<T> tList, String[] description, String area) {			//박스를 각 배송지로 배분하는 method
		switch (area) {
		case ("GyeongGi-dou"):
	...
	public static void main(String[] args) {		//main method
		...
		if(index == -1) {
			...
			System.out.println("The box to " + gList.get(index).getDescription() + " is actually has to go to " + gList.get(index).getArea() + "! late! hurry up!\n"); 
		}
